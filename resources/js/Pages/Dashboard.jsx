                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-surface rounded-3xl p-6 border border-[#F0EBE1] shadow-sm md:col-span-1 flex flex-col justify-between">
                        <div>
                            ...
                            <p className="text-sm text-text-secondary mb-6">
                                Kamu sudah berlatih 2 hari minggu ini. Teruskan!
                            </p>
                        </div>
                    ...
                    <div className="md:col-span-2 grid grid-cols-2 gap-6">
                        <Link
                            ...
                            className="bg-secondary/10 hover:bg-secondary/20 transition-colors rounded-3xl p-6 border border-secondary/20 flex flex-col justify-center items-start group"
                        >
                            ...
                            <p className="text-sm text-text-secondary mt-1">
                                Lihat jadwal & pesan sesi baru.
                            </p>
                        </Link>

                        <Link
                            href={route("packages.index")}
                            className="bg-background hover:bg-[#EBE5DA] transition-colors rounded-3xl p-6 border border-[#F0EBE1] flex flex-col justify-center items-start group"
                        >
