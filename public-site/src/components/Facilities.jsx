...
export default function Facilities() {
    const facilities = [
        ...
        { name: "Health Checker", icon: HeartPlus },
        { name: "Gym Tips", icon: Info },
    ];

    return (
        <section id="facilities" className="py-24 bg-[#1c1917] text-white">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-white/70 max-w-2xl mx-auto">
                        Kenyamanan Anda adalah prioritas kami. Nikmati berbagai
                        fasilitas premium yang telah kami sediakan untuk
                        pengalaman Pilates terbaik.
                    </p>
                </div>
