            ...
            <div className="max-w-6xl mx-auto px-4 relative">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden md:flex gap-8 items-center font-medium h-full">
                        <Link
                            href="/"
                            className="text-foreground/80 hover:text-sage transition"
                        >
                            Home
                        </Link>
                        <Link
                        ...
                        <div className="group h-full flex items-center relative">
                            <Link
                                href="/classes"
                                className="text-foreground/80 hover:text-sage transition py-8"
                            >
                                Classes
                            </Link>
                            ...
                            <div className="absolute top-[80px] left-1/2 -translate-x-1/2 w-screen max-w-5xl invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-300 pt-4">
                                <div className="bg-white rounded-3xl shadow-xl border border-sage/10 p-8">
                                    <div className="flex justify-between items-center border-b border-blush/30 pb-4 mb-6">
                                        ...
                                        <Link
                                            href="/classes"
                                            className="text-sage font-semibold hover:text-sage-light"
                                        >
                                            View all &rarr;
                                        </Link>
                                    </div>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div className="aspect-video w-full rounded-xl bg-sage/20 mb-3 overflow-hidden">
                                                            {cls.photo ? (
                                                                <img
                                                                    src={`http://127.0.0.1:8000/storage/${cls.photo}`}
                                                                    alt={
                                                                        cls.title
                                                                    }
                                                        ...
                                                        <h4 className="font-semibold text-foreground group-hover/item:text-sage transition">
                                                            {cls.title}
                                                        </h4>
                    ...
                    <div className="hidden md:flex">
                        <a
                            ...
                            className="px-6 py-2 bg-sage-800 text-white rounded-full hover:bg-sage-light transition font-semibold"
                        >
                            Book Now
                        </a>
                    </div>
