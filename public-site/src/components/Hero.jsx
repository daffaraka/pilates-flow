...
export default function Hero() {
    return (
        <section id="home" className="relative w-full h-[80vh] flex flex-col justify-center items-center bg-ivory text-foreground overflow-hidden">
            <div className="absolute inset-0 bg-sage/10 -z-10"></div>
            <div className="text-center px-4 max-w-4xl mx-auto">
                <h1 className="text-8xl md:text-7xl font-bold tracking-tight mb-6 mt-24">
                    Find Your Flow. <br /> Strengthen Your Core.
                </h1>
                <p className="text-lg md:text-2xl text-foreground/80 mb-10 max-w-2xl mx-auto">
                    Experience mindful movement and holistic wellness with our
                    expert-led Pilates classes designed for all levels.
                </p>
